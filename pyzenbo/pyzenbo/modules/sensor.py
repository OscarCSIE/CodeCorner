...
class Sensor:
    ...
    def register_capacity_touch_sensor_event(self,
                                             event_type=0,
                                             sync=True,
                                             timeout=None):
        """
    ...
    def unregister_capacity_touch_sensor_event(self,
                                               event_type=0,
                                               sync=True,
                                               timeout=None):
        """
    ...
    def register_sonar(self, position, interval=0.5, sync=True, timeout=None):
        ...
        data = {
            'position': int(position) if 0 <= int(position) <= 2 else 255,
    ...
    def unregister_sonar_event(self,
                               position,
                               operator,
                               value,
                               sync=True,
    ...
    def register_neck_encoder_event(self,
                                    operator,
                                    value,
                                    sync=True,
                                    timeout=None):
    ...
    def unregister_neck_encoder_event(self,
                                      operator,
                                      value,
                                      sync=True,
                                      timeout=None):
    ...
    def wait_for_trigger_key_event(self, timeout=10):
        ...
        if result is not None and result['state'] == 5:
            ...
            logger.warning(
                'register trigger key start fail serial:%d, result:%s', serial,
                result)
