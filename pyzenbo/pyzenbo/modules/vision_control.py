...
class VisionControl:
    ...
    def cancel_detect_face(self):
        ...
        data = {}
        serial, error = self._inter_comm.send_command(des, cmd, data, False,
                                                      None)
        return serial, error
    ...
    def request_detect_person(self,
                              interval=1,
                              enable_debug_preview=False,
                              enable_detect_head=False,
                              sync=False,
    ...
    def request_recognize_person(self,
                                 interval=1,
                                 enable_debug_preview=False,
                                 enable_detect_head=False,
                                 enable_face_posture=False,
    ...
    def wait_for_detect_face(self,
        ...
        """
        self.request_detect_face(interval, enable_debug_preview,
                                 enable_detect_head, enable_face_posture,
    ...
    def wait_for_recognize_person(self,
        ...
        """
        self.request_recognize_person(interval, enable_debug_preview,
                                      enable_detect_head, enable_face_posture,
                                      enable_candidate_obj,
                                      enable_head_gaze_classifier)
