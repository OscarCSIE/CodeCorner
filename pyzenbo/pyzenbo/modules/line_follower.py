...
class LineFollower:
    ...
    def follow_line(self, json_string=None, sync=True, timeout=None):
        ...
        if json_string is None:
            ...
            config.add_rule(LineFollowerConfig.COLOR['BLACK'],
    ...
    def set_behavior(self, serial, behavior, arg=None, sync=True, timeout=None):
        """
        ...
        cmd = commands.UTILITY_SEND_INFO
        config = LineFollowerConfig()
        config.add_rule(LineFollowerConfig.COLOR['RED'], behavior, arg)
