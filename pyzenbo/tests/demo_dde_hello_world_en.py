...
domainUuid = "CC15F55A73A747F8AE5F0B501E85676A"
        ...
        if app_semantic:
            ...
            if intention_id:
                ...
                if intention_id == "lanuchHelloWolrd_Plan":
                    sdk.robot.speak('Hello, I am Zenbo, nice to meet you')
                    sdk.robot.speak(
                        'Which city do you like, you may say hello black city or hello white city'
                    )
                ...
                if intention_id == "helloWorld":
                    ...
                    # TTS
                    sdk.robot.speak('You are now at ' + str(city_name))
